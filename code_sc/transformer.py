...
class AttentionMatrix(tf.keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        # atten = tf.einsum('bij,bkj->bik', Q, K)
...
class AttentionHead(tf.keras.layers.Layer):
    def __init__(self, input_size, output_size, is_self_attention, **kwargs):
        ...
        # def make_variables(*dims, initializer=tf.keras.initializers.GlorotNormal()): 
        #     return tf.Variable(initializer(dims))
